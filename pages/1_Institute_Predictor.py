...
st.set_page_config(page_title="Institute Predictor", page_icon="🏫", layout="centered")

render_theme_selector()

st.title("🏫 Predict Your Institute")
st.caption("Enter your details to see the institutes you're most likely to get, ranked by probability.")
...
with st.form("institute_form"):
    ...
    top_n = st.slider("Number of colleges to show", min_value=3, max_value=20, value=5)
...
if submitted:
    ...
    try:
        ...
        st.markdown(f"### Top {len(results)} Predicted Institutes")
